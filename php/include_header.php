...
<head>
	...
	<title>ಪ್ರಬುದ್ಧ ಕರ್ಣಾಟಕ</title>
</head>
<body>
	<header class="cd-header">
		<div id="cd-logo">
			<a href="../index.html#home">
				<img src="img/logo.gif" alt="ಪ್ರಬುದ್ಧ ಕರ್ಣಾಟಕ">
			</a>
		</div>
		<nav class="cd-main-nav">
			<ul>
				<li><a href="../index.html">ಮುಖಪುಟ</a></li>
				<li><a href="#">ಒಳನೋಟ</a></li>
				<li><a href="#">ಸಂಪಾದಕರು</a></li>
		...
		<div id="cd-sec-nav">
			...
			<nav id="cd-sec-main-nav">
				<ul>
					<li><a href="volumes.php"><i class="fa fa-calendar"></i> ಸಂಪುಟಗಳು</a></li>
					<li><a href="articles.php"><i class="fa fa-files-o"></i> ಲೇಖನಗಳು</a></li>
					<li><a href="authors.php"><i class="fa fa-users"></i> ಲೇಖಕರು</a></li>
					<li><a href="features.php"><i class="fa fa-tags"></i> ಸ್ಥಿರ ಶೀರ್ಷಿಕೆಗಳು</a></li>
